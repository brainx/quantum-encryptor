...
class CryptoConfig:
    ...
    MLKEM768_PRIVATE_KEY_BYTES = 2400
    MLKEM768_PKE_PRIVATE_KEY_BYTES = 1152
    MLKEM768_PUBLIC_POLY_BYTES = 1152
    MLKEM_MODULUS = 3329
    HYBRID_PUBLIC_KEY_BYTES = X25519_KEY_BYTES + MLKEM768_PUBLIC_KEY_BYTES
    HYBRID_PRIVATE_KEY_BYTES = X25519_KEY_BYTES + MLKEM768_PRIVATE_KEY_BYTES
